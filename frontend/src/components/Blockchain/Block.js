...
function mine(event, blockno, user){
    ...
    var nonceVal = document.getElementsByClassName("block-nonce-val"+blockno.toString()+user)[0].value;
        ...
        return (
            <div className="block-tx" key={i}>
                <div className="flex">
                    ...
                    <input className={"block-val block-txs-amt" + blockno.toString()+user} defaultValue={tx.amt} />
        ...
        <div className={"block b" + props.block.toString()}>
            ...
            <div className="block-main">
                ...
                <div className="block-nonce">
                    ...
                    <input className={"block-val block-nonce-val"+props.block.toString()+props.user} defaultValue = {props.nonce}/>
                </div>
            </div>
            ...
            <div className="block-coinbase flex">
                <div className="block-info">Amt</div>
                <input className={"block-val block-coin-val" +props.block.toString()+props.user} defaultValue={props.coin.amt} />
                <div className="block-info">To</div>
    ...
    return(
        <div className="chain-holder">
            ...
            <div className="chain">
                ...
                ]} prevHash={0} hash={0} user={props.user}/>
